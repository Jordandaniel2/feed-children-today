          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                <Mail size={16} />
                <a href="mailto:hello@feedchildren.today" className="text-primary-foreground/70 hover:text-primary-foreground transition">
                  hello@feedchildren.today
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} />
                <a href="tel:+1234567890" className="text-primary-foreground/70 hover:text-primary-foreground transition">
                  +1 (234) 567-890
                </a>
              </li>
            </ul>
